...
import { signup, login, fileToDataUrl } from '../lib/api';
              ...
              <label className="text-xs text-gray-600 font-medium">
                ...
                <input
                  ...
                  onChange={async (e) => {
                    ...
                    setAvatar(file ? await fileToDataUrl(file) : '');
                  }}
                  className="block mt-1 text-xs file:mr-2 file:px-3 file:py-1 file:rounded-lg file:border-0 file:bg-[#e8f2d8] file:text-[#426306] file:font-semibold"
                />
              </label>
            </div>
          )}
